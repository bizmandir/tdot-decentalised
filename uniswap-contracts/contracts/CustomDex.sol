...
contract CustomDex {
    ...
    string[] public tokens = ["AskTrabaajo", "tdot", "COKU"];

    // map to maintain the tokens and its instances
    mapping(string => ERC20) public tokenInstanceMap;

    // 1 AskTrabaajo/tdot/COKU = 0.0001 eth
    uint256 ethValue = 5000000000000000000;

    // 0.0001 eth = 1 AskTrabaajo/tdot/COKU
    // 1 AskTrabaajo/tdot/COKU = 1 AskTrabaajo/tdot/COKU
