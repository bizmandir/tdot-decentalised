...
const Header = () => {
  ...
  useEffect(() => {
    setTokenBalComp(
      <>
            <TokenBalance name={'AskTrabaajo(coinA)'} walletAddress={address} />
            <TokenBalance name={'3DOT(coinB)'} walletAddress={address} />
            <TokenBalance name={'COKU(coinC)'} walletAddress={address} />
      </>,
    )
